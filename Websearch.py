    ...
    def search(query: str) -> SearchResult:
        ...
        try:
            ...
            response = client.chat.create(
                ...
                messages=[
                    {"role": "assistant", "content": "You are Grok, an AI assistant with real-time web search capabilities. Always provide accurate, current information and cite your sources when possible. Use your live search feature to find the most recent information available."},
